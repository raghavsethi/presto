...
import static com.facebook.presto.spi.StandardErrorCode.OVERFLOW;
        ...
        extends AbstractFixedWidthType
{
    ...
    private IntType()
    {
        super(parseTypeSignature(StandardTypes.INT), long.class, SIZE_OF_INT);
    }
    ...
    public void writeLong(BlockBuilder blockBuilder, long value)
    {
        if (value > Integer.MAX_VALUE) {
            throw new PrestoException(OVERFLOW, String.format("Value %d exceeds MAX_INT", value));
        }
        else if (value < Integer.MIN_VALUE) {
            throw new PrestoException(OVERFLOW, String.format("Value %d is less than MIN_INT", value));
        }
