...
public class TestSerDeUtils
{
    ...
    public void testPrimitiveSlice()
    {
        ...
        Block actualByte = toBinaryBlock(INT, (byte) 5, getInspector(Byte.class));
        ...
        Block actualShort = toBinaryBlock(INT, (short) 2, getInspector(Short.class));
        ...
        Block actualInt = toBinaryBlock(INT, 1, getInspector(Integer.class));
    ...
    public void testListBlock()
    {
        ...
        com.facebook.presto.spi.type.Type rowType = new RowType(ImmutableList.of(INT, BIGINT), Optional.empty());
        ...
        rowType.writeObject(blockBuilder, rowBlockOf(ImmutableList.of(INT, BIGINT), 8, 9L));
        rowType.writeObject(blockBuilder, rowBlockOf(ImmutableList.of(INT, BIGINT), 10, 11L));
    ...
    public void testMapBlock()
    {
        ...
        rowType.writeObject(blockBuilder, rowBlockOf(ImmutableList.of(INT, BIGINT), 16, 17L));
        VARCHAR.writeString(blockBuilder, "twelve");
        rowType.writeObject(blockBuilder, rowBlockOf(ImmutableList.of(INT, BIGINT), 13, 14L));
    ...
    public void testStructBlock()
    {
        ...
        Block expected = rowBlockOf(ImmutableList.of(INT, BIGINT), 13, 14L);
        assertBlockEquals(actual, expected);
        ...
        com.facebook.presto.spi.type.Type innerRowType = new RowType(ImmutableList.of(INT, BIGINT), Optional.empty());
        ...
        List<com.facebook.presto.spi.type.Type> outerRowParameterTypes = ImmutableList.of(INT, INT, INT, BIGINT, DOUBLE, DOUBLE, VARCHAR, VARCHAR, arrayOfInnerRowType, mapOfInnerRowType, innerRowType);
        ...
        outerRowValues.add(arrayBlockOf(innerRowType, rowBlockOf(ImmutableList.of(INT, BIGINT), 2, -5L), rowBlockOf(ImmutableList.of(INT, BIGINT), -10, 0L)));
        BlockBuilder blockBuilder = new InterleavedBlockBuilder(ImmutableList.of(VARCHAR, innerRowType), new BlockBuilderStatus(), 1024);
        VARCHAR.writeString(blockBuilder, "fifteen");
        innerRowType.writeObject(blockBuilder, rowBlockOf(ImmutableList.of(INT, BIGINT), -5, -10L));
        VARCHAR.writeString(blockBuilder, "twelve");
        innerRowType.writeObject(blockBuilder, rowBlockOf(ImmutableList.of(INT, BIGINT), 0L, 5L));
        outerRowValues.add(blockBuilder.build());
        outerRowValues.add(rowBlockOf(ImmutableList.of(INT, BIGINT), 18, 19L));
