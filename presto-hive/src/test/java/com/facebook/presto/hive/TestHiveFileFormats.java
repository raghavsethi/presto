        ...
        extends AbstractTestHiveFileFormats
{
            ...
            throws Exception
    {
        ...
        RowType personType = new RowType(ImmutableList.of(nameType, INT, VARCHAR, new ArrayType(phoneType)), Optional.empty());
        ...
        List<TestColumn> testColumns = ImmutableList.<TestColumn>of(
            new TestColumn(
                ...
                arrayBlockOf(personType,
                        rowBlockOf(ImmutableList.of(nameType, INT, VARCHAR, new ArrayType(phoneType)),
