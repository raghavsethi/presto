...
public class TestExchangeClient
{
            ...
            throws Exception
    {
        ...
        ExchangeClient exchangeClient = new ExchangeClient(blockEncodingManager, new DataSize(32, Unit.MEGABYTE), maxResponseSize, 1, new Duration(1, TimeUnit.MINUTES), new TestingHttpClient(processor, executor), new ExchangeHttpStats(), executor, deltaMemoryInBytes -> { });
            ...
            throws Exception
    {
        ...
        @SuppressWarnings("resource")
        ExchangeClient exchangeClient = new ExchangeClient(blockEncodingManager, new DataSize(32, Unit.MEGABYTE), maxResponseSize, 1, new Duration(1, TimeUnit.MINUTES), new TestingHttpClient(processor, newCachedThreadPool(daemonThreadsNamed("test-%s"))), new ExchangeHttpStats(), executor, deltaMemoryInBytes -> { });
            ...
            throws Exception
    {
        ...
        @SuppressWarnings("resource")
        ExchangeClient exchangeClient = new ExchangeClient(blockEncodingManager, new DataSize(1, Unit.BYTE), maxResponseSize, 1, new Duration(1, TimeUnit.MINUTES), new TestingHttpClient(processor, newCachedThreadPool(daemonThreadsNamed("test-%s"))), new ExchangeHttpStats(), executor, deltaMemoryInBytes -> { });
